...
impl Assets {
    pub fn new() -> Assets {
        let non_html_assets = NonHtmlAssets::new();
        let non_html_assets = Rc::new(non_html_assets);

        let index_html = HtmlAsset {
            asset_path: "index.html",
            contents: crate::routes::get(non_html_assets.clone()),
        };
    ...
    pub fn save_to_disk(&self, built_dir: &Path, mode: &Mode) {
        ...
        self.non_html_assets.save_to_disk(built_dir, mode);
    }
...
impl NonHtmlAssets {
    pub fn new() -> NonHtmlAssets {
        ...
        let hasui_light_jpeg = ImageAsset::new(
            "hasui-light.jpeg",
            "A mountain in the distance",
            include_bytes!("../assets/hasui_light.jpeg"),
        ...
        let hasui_dark_jpeg = ImageAsset::new(
            "hasui-dark.jpeg",
            "A town at night",
            include_bytes!("../assets/hasui_dark.jpeg"),
